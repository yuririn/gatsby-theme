...
![スペースをタブ設定しておく](./images/04/entry450-11.jpg)
...
![拡張機能からphpcsを検索してインストール](./images/04/entry450-0.jpg)
...
![homebrew インストール](./images/04/entry450-1.jpg)
...
![中に、.composerディレクトリがあったらOK！](./images/04/entry450-2.jpg)
...
![バージョンを調べます](./images/04/entry450-3.jpg)
...
![プロジェクト用のsettings.jsonを編集](./images/04/entry450-4.jpg)
...
![ワークスペース用のsettings.json](./images/04/entry450-5.jpg)
...
![ワークスペース用のsettings.json](./images/04/entry450-12.jpg)
...
![phpcs.executablePathのパスを調べる](./images/04/entry450-14.jpg)
