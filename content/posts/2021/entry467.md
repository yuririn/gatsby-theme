...
faq:
  - q: "IT業界で「サチコ」という女性の名前を耳にしますが誰のことですか？"
    a: "人名ではなく、Googleの解析ツール「Google Search Console（グーグル・サーチコンソール）」の愛称です。日本の一部コミュニティで略して呼ばれますが、[サチコの正体](#番外だけどおまけ・サチコ) セクションで解説している通り、Googleの中の人はそう呼ばないというシュールな事実があります。"
  - q: "「アジェンダ」と「議題」は何が違うのですか？"
    a: "実質的な意味は同じですが、IT業界では「アジェンダ」と呼ぶ方がプロっぽく（？）聞こえるため多用されます。ただ、やりすぎると「かぶれている」と思われる諸刃の剣です。本記事の [アジェンダの考察](#アジェンダ) では、もっと親しみやすい言い換えも提案しています。"
  - q: "IT業界の「デスマ（デスマーチ）」を回避する方法はありますか？"
    a: "デスマーチは過酷なプロジェクト状況を指しますが、回避には適切な工数見積もりと「ASAP（なるはや）」という曖昧な言葉を禁止することが第一歩です。デスマのリアルな実態については [デスマーチの項目](#デスマーチ（デスマ）) を参考に、心の準備（？）をしてみてください。"
  - q: "「エビデンス」を日本語でカッコよく言い換えるなら？"
    a: "「裏付け」や「確証」と言い換えると、横文字に頼らない知的な印象を与えられます。あえて「エビデンス」を使う心理については [エビデンスのセクション](#エビデンス) で深掘りしていますが、相手に合わせて言葉を選ぶのが一番の「脱・かぶれ」への近道です。"
---
