...
faq:
  - q: "IT業界で「サチコ」という女性の名前を耳にしますが誰のことですか？"
    a: "人名ではなく、Googleの解析ツール「Google Search Console（グーグル・サーチコンソール）」の愛称です。日本の一部コミュニティで略して呼ばれますが、 [サチコの正体](#番外だけどおまけサチコ) セクションで解説している通り、Googleの中の人はそう呼ばないというシュールな事実があります。"
  ...
  - q: "IT業界の「デスマ（デスマーチ）」を回避する方法はありますか？"
    a: "デスマーチは過酷なプロジェクト状況を指しますが、回避には適切な工数見積もりと「ASAP（なるはや）」という曖昧な言葉を禁止することが第一歩です。デスマのリアルな実態については [デスマーチの項目](#デスマーチデスマ) を参考に、心の準備（？）をしてみてください。"
