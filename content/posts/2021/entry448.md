...
faq:
  - q: "Facebook Appの審査が通らなくて心が折れそうです…。"
    a: "個人利用やテスト目的であれば、審査なしの「開発モード」のままでも自分自身のアカウント投稿は取得可能です。2026年現在、 **一般公開（ライブモード）にするにはプライバシーポリシーのURL設定などが必須** となるため、 [エラー対策のセクション](#突然のエラーデータが取得できない2021-12-24追記) をまずチェックしてください。"
