...
tags: ["GAS","JavaScript"]
description: プログラミングで事務作業を自動化して効率化しよう！前回に続き、Google Apps Scriptを使って 1.スプシ（Googleスプレッドシート）からファイルアップロード2.ルール通りにファイルをリネーム保存 3.スプシにファイル情報を自動で追記する方法をご紹介します。
lead: ["プログラミングで事務作業を自動化して効率化しよう！","前回に続き、Google Apps Scriptを使って 1.スプシ（Googleスプレッドシート）からファイルアップロード
2.ルール通りにファイルをリネーム保存 3.スプシにファイル情報を自動で追記する方法をご紹介します。"]
---
