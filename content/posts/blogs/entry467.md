...
tags: ["おもしろ"]
description: IT業界。この業界にいると横文字をはじめとするナゾのナゾな言葉を使うことが多いです。最近お客さんと話していて、「本当に使う必要ある？」って思うものも多いです。そこで【かぶれた用語】10コ厳選し、意味や必要性をまとめてみました。
lead: ["IT業界。この業界にいると横文字をはじめとするナゾの言葉を使うことが多いです。","最近お客さんと話していて、「本当に使う必要ある？」って思うものも多いです。そこで【かぶれた用語】10コ厳選し、意味や必要性をまとめてみました。"]
---
...
めっちゃ大事で、目を引く写真やキャッチコピーなどコンテンツの続きを読んでもらえるかに影響を与えます。
...
「ITリテラシーが高い、低い」のような使い方をよくします。

ざっくりいうと大きく3つの知識や技術を理解力を示します。

1. 情報を正しく使う能力や知識
2. コンピューターの知識や技術
3. ネットワークやセキュリティに関する技術的な知識

「コンピューターの知識や技術」と「ネットワークやセキュリティに関する技術的な知識」がどんなに長けた人間でもSNSで情報漏洩するような場合、ITリテラシーが必ずしも高いと言えないかもしれません。
...
インターネットで検索することを*google it*と言いますが、いつか*amazon it*という日も来るかもしれませんね！
...
### アサイン
何かのプロジェクトに人を投入するときに使います。

私は職業柄コーディングで普段から目に触れるせいか、個人的には*height*とか*align*など、間に発音しないgが入る単語が好きです。
...
定量的じゃないこの言葉、個人的には*不要*だと思っています。

「ASAPでやります」という人で、早くやってる人をぶっちゃけ見たことないからです。
...
### ジョイン
中学生ぐらいで習う単語だと思いますが、参加するって意味です。

我々の会社にジョイン、我々のチームにジョイン。
