...
lead: ["WordPressって人気ですよね。WordPress使ってブログ始めたいけど何から手をつけていいかわからない！って相談をよく受けます。","そこで、初心者でもWordPressでブログを最善の状態で始められる方法を考えました。","私は仕事柄、多いときは月3つ以上のペースでWordPressサイトに向き合ってます。経験と知識は積み上がってるので、価値のある情報を提供できると思います。","この記事は前半・後半に分かれていて前半ではサーバーの選び方や注意点、WordPressのインストール方法について解説します。"]
---
