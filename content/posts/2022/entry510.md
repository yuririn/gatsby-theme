...
faq: [['ヒートマップとは何ですか？','サイトに訪れたユーザーのページ内での行動データを、色の濃淡でわかりやすく表現したものです。'],['Clarity 導入方法','Google、Facebook、Microsoftのアカウントがあればすぐに始めることができます。','導入方法'],['Clarityのヒートマップ表示されない','見たいページの抽出をし直すと解決することがあります。','ヒートマップ表示されない場合２０２２年１２月追記']]
---
