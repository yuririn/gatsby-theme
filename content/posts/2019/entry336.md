...
![単一ファイル内での置換](./images/entry336-1.png)
...
![複数のファイル内での置換](./images/entry336-2.png)
...
<ad location="/blogs/entry336/"></ad>

## 細かい絞り込み
ちょっとわかりにくいんですが...ボタンをクリックするとさらにinput窓が出現します。

![細かい絞り込み](./images/entry336-3.png)
...
![除外するファイル](./images/entry336-4.png)
...
![VS Codeには大文字・小文字変換機能](./images/entry336-7.jpg)
...
![挿入したいテーブルを丸っとコピーしてVS Codeに貼り付け](./images/entry336-6.jpg)
