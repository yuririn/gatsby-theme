...
![MW WP Form ラジオボタンのカスタマイズ](./images/07/entry374-1.png)
...
![クラスを付与するためにショートコードを挿入する時に以下のような設定](./images/07/entry374-2.png)
...
![MW WP Form チェックボックス のカスタマイズ法](./images/07/entry374-3.png)

仕上がりイメージはこんな感じ。
![MW WP Form チェックボックス のカスタマイズ法](./images/07/entry374-4.png)
...
![Contact Form 7ラジオボタンのカスタマイズ法](./images/07/entry374-5.png)
...
```
![Contact Form 7ラジオボタン仕上がり例](./images/07/entry374-6.png)
...
```
![Contact Form 7チェックボックス仕上がり例](./images/07/entry374-8.png)
