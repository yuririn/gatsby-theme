---
title: Gatsbyブログサイト移行物語2~投稿ページの充実と画像の方法~
date: 2020-11-30
hero: entry401.jpg
pagetype: blog
category: Front End
...
description: 現在GatsbyJSでサイトのリニューアル中です！ブログのファーストビューって大切ですよね。アイキャッチ次第で読むか読まないか考えますもん。今回はブログページを充実させるためにアイキャッチなどを追加する方法をご紹介します。以降のため、CSSの調整も行いました！※ Mac以外では検証してません。ご了承ください。
lead: ["フロントエンドエンジニアのかみーゆです。","現在GatsbyJSでサイトのリニューアル中です！","ブログのファーストビューって大切ですよね。アイキャッチ次第で読むか読まないか考えますもん。","今回はブログページを充実させるためにアイキャッチなどを追加する方法をご紹介します。","※ Mac以外では検証してません。ご了承ください。"]
---
## 今までのGatsbyの記事と注意点
現在ここまで記載しています。<br>
...
```
クエリにheroを足し、ついでに日本人からするとなじみのない日付のフォーマットも変えてしまします。
...
私の場合は今回記事の以降なので記事を改めて書くのはスーパー面倒です。
...
今回は記事内にアイキャッチ画像を出力しましたが、他のテンプレートにも画像は出力できめっちゃ便利です。
