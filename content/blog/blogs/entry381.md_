...
date: 2020-08-02
hero: thumbnail/2020/entry381.png
pagetype: blog
cateId: 'cms'
tags: ["WordPress"]
...
カテゴリ記事が増えてきたらカテゴリごとに一覧ページが勝手に作られます。<br>
ユーザーも見たいジャンルの記事が一気に探せてベンリです。

カテゴリにもスラック設定があります。<br><br>
...
ちゃんと設定してないとカテゴリ名がそのままスラックとして適用されます。日本語はマルチバイト文字なのでなっがーいURLになってしまいます。<br>
記事ごとのスラック同様、必ず英語でタイトルをつけましょう。

カテゴリごとに名前とスラックと説明を設定しておきましょう。
![カテゴリの設定](./images/2020/08/entry381-9.jpg)

#### タグの設定
タグもカテゴリ同様、細かいキーワードのジャンルごとに記事の整理ができます。カテゴリは階層構造を持てますが、タグは持てません。

カテゴリでしっかりカテゴライズする分、タグは意識せず自由度高く使うことをオススメします。混乱しそうであれば、あえて**使わないという選択肢**もあります。
...
### アイキャッチ、カテゴリ、カテゴリ、スラックを設定したら公開だ！！
アイキャッチ、カテゴリ、カテゴリ、スラックすべて設定したら公開しましょう。<br>
