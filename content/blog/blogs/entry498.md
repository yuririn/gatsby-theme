---
title: 【構造化データでSEO対策】パンくずリストのリッチリザルトを表示させる(コードサンプルつき)
date: 2022-04-21
modifieddate: 2022-06-11
pagetype: blog
cateId: seo
hero: thumbnail/2022/entry498.png
tags: ["構造化データ",'CSS']
description: リッチリザルトはクリック率が上がりSEOで有利。パンくずリストのリッチリザルトの表示方法について詳しく解説。タグの書き方、構造化データの記述方法（リッチリザルト表示）、デザインも含めたコーディングサンプルもご紹介します。
lead: ["リッチリザルトはクリック率が上がりSEOで有利。パンくずリストのリッチリザルトの表示方法について詳しく解説しました。","そもそもパンくずリストって何？設置するとどのように有利なの？どんな設置の仕方がいいの？","そんな疑問を解説しつつ、タグの書き方、構造化データの記述方法（リッチリザルト表示）、デザインも含めたコーディングサンプルもご紹介します。"]
---
## パンくずリストてなんぞ？
