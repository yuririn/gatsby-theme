---
title: 【SEO】パンくずリストのリッチリザルト（構造化データ）を効果的に表示する方法
date: 2022-04-21
...
tags: ["構造化データ",'CSS']
description: パンくずリストの構造化データの書き方やリッチリザルトの表示方法について詳しく解説。パンくずリストのリッチリザルトが表示されるとクリック率が上がるなど、SEO効果が期待できます。コピペで使えるデザインも含めたコーディングサンプルもご紹介します。
lead: ["SEOでクリック率を上げる強力な手段のひとつとしてリッチリザルトが挙げられます。","リッチリザルトの中でも一番取り入れやすいのがパンくずリストです。今回はパンくずリストのリッチリザルトの表示方法について詳しく解説しました。リッチリザルトはクリック率が上がりSEOで有利。","そもそもパンくずリストって何？設置するとどのように有利なの？どんな設置の仕方がいいの？","そんな疑問を解説しつつ、タグの書き方、構造化データの記述方法（リッチリザルト表示）、デザインも含めたコーディングサンプルもご紹介します。コピペで使えます！"]
---
## パンくずリストてなんぞ？
...
パンくずリスト用の構造化データが設置されていると、検索結果画面にパンくずリストの *リッチリザルト* として表示されます。
...
詳細度の高いパンくずリストとは、より細かいパンくずがあります。

以前の銀ねこアトリエと他のサイトとの検索結果の比較です。
...
なので銀ねこアトリエでもありきたりの記事一覧という項目は削除し、ジャンルやタグ一覧を表示できるように改善しました。
