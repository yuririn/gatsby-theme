---
title: 【構造化データでSEO対策】パンくずリストのリッチリザルトを表示(コードサンプルあり)
date: 2022-04-21
...
tags: ["構造化データ",'CSS']
description: SEO対策でもパンくずリストについて詳しく解説。設置するとどのように有利なのか？タグの書き方、構造化データの記述方法（リッチリザルト）、デザインも含めたコーディングサンプルもご紹介します。
lead: ["SEO対策でも有用なパンくずリストについて詳しく解説しました。","そもそもパンくずリストって何？設置するとどのように有利なの？どんな設置の仕方がいいの？","そんな疑問を解説しつつ、タグの書き方、構造化データの記述方法（リッチリザルト）、デザインも含めたコーディングサンプルもご紹介します。"]
---
## パンくずリストてなんぞ？
