...
1.  **Open the source code and start editing!**
    ...
    _Note: You'll also see a second link: _`https://ginneko-atelier.com/___graphql`_. This is a tool you can use to experiment with querying your data. Learn more about using this tool in the [Gatsby Tutorial](https://www.gatsbyjs.com/docs/tutorial/part-4/#use-graphiql-to-explore-the-data-layer-and-write-graphql-queries)._
...
ffmpeg -i entry315-10.gif -movflags faststart -pix_fmt yuv420p -vf "scale=trunc(iw/2)*2:trunc(ih/2)*2" 名称未設定.mp4
