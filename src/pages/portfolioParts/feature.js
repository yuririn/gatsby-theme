...
const Fearure = () => (
	...
	<section className="l-container">
		<header className={CommonStyles.headingMd}>
			<h3><FontAwesomeIcon icon={faFistRaised} /> こんなことできるよ</h3>
		</header>
		<p className={CommonStyles.center}>得意、不得意は別としてできることを<strong className={CommonStyles.strong}>タグクラウド風</strong>にまとめておきます。</p>
