...
const Works = () => (
  <Grid>
    <Article>
      ...
      <Img filename="portfolio/hirohata.jpg" className="img"></Img>
    </Article>
    <Article>
      <Link to="/blogs/entry279/">
        ...
        <Img filename="2018/entry279.jpg" className="img"></Img>
      </Link>
    </Article>
    <Article>
      <Link to="/blogs/tags/CSS/">
        ...
        <Img filename="2020/entry393.png" className="img"></Img>
      </Link>
    </Article>
    ...
    <Article>
      ...
      <Img filename="portfolio/danball.jpg" className="img"></Img>
    </Article>
    <Article>
      <Link to="https://dream-tech.jp/" target="_blank" rel="noopener nofollow">
        ...
        <Img filename="portfolio/happy-chime.jpg" className="img"></Img>
      </Link>
    </Article>
    ...
    <Article>
      <Link to="/blogs/entry356/">
        ...
        <Img filename="2020/entry356.png" className="img"></Img>
      </Link>
    </Article>
    <Article>
      <Link to="/blogs/entry357/">
        ...
        <Img filename="2020/entry357.jpg" className="img"></Img>
      </Link>
    </Article>
    <Article>
      <section>
      ...
      <Img filename="portfolio/nexseed_labo.jpg" className="img"></Img>
    </Article>
    <Article>
      <Link to="/blogs/entry369/">
        ...
        <Img filename="2020/entry369.jpg" className="img"></Img>
      </Link>
    </Article>
    <Article>
      <Link to="/blogs/entry389/">
        ...
        <Img filename="2020/entry389.jpg" className="img"></Img>
      </Link>
    </Article>
    <Article>
      <Link to="/">
        ...
        <Img filename="portfolio/ginneko.jpg" className="img"></Img>
      </Link>
    </Article>
    <Article>
      <Link
      ...
      >
        ...
        <Img filename="2020/entry415.jpg" className="img"></Img>
      </Link>
    </Article>
  </Grid>
);
