...
const AboutContent = () => {
    ...
    <>
        ...
        <RelativeCard slug="entry382"></RelativeCard>
        <p>
        ...
        <RelativeCard slug="entry321"></RelativeCard>
        ...
        <RelativeCard slug="entry386"></RelativeCard>
        ...
        <div className="box">
            <ul>
                    ...
                    <li>特技：細かい作業（米に字を描くとか）・イラスト・運動神経はいい方</li>
