module.exports = {
  siteMetadata: {
    ...
    ad: {
      ...
      author: {
        name: `かみーゆ`,
        summary: `世界最長ロックダウンをくぐり抜け、資金ゼロからフィリピンで起業した海外ノマドエンジニア。Web制作・運用10年以上ですが、CHOCOっとBLOGでは本業と関係ないことを綴っていきます。愛するチョコボ（黒ネコ）と4年も離れ暮らしています。人生のKPIは「生きたいように生きて死にたいように死ぬ」`,
      },
